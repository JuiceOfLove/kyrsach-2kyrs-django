...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=25, verbose_name='Название объявления')),
                ...
                ('photo', models.FileField(upload_to='photos', verbose_name='Фото объявления')),
                ('author', models.ManyToManyField(to='Avtoapi.user', verbose_name='Автор объявления')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(verbose_name='Текс объявления')),
                ('likes', models.IntegerField(validators=[Avtoapi.models.validate_likes], verbose_name='Количество лайков')),
                ('photo', models.TextField(max_length=100, verbose_name='Текс объявления')),
                ('history_id', models.AutoField(primary_key=True, serialize=False)),
                ('history_date', models.DateTimeField(db_index=True)),
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
